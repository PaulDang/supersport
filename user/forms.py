...
class ChangePasswordForm(forms.Form):
    current_password = forms.CharField(label="Mật khẩu cũ: ", widget=forms.PasswordInput)
    new_password = forms.CharField(label="Mật khẩu mới:", widget=forms.PasswordInput)
    confirm_password = forms.CharField(label="Xác nhận lại mật khẩu  ", widget=forms.PasswordInput)
