...
urlpatterns = [
    ...
    path(
        "dashboard/app_brand_add/", views.app_brand_add, name="add_brand_app"
    ),  # add trong form upload product
    path("dashboard/product/brand_list/", views.brand_list, name="brand_list"),
    path(
        "dashboard/product/update_brand/<int:brand_id>/",
        views.edit_brand,
        name="edit_brand",
    ),
    path(
        "dashboard/product/delete_brand/<int:brand_id>/",
        views.delete_brand,
        name="delete_brand",
    ),
    # Category
    ...
    path(
        "dashboard/app_category_add/", views.add_category_app, name="add_category_app"
    ),
    path(
        "dashboard/add-category/", views.add_category, name="add_category"
    ),  # add trong form upload product
    path(
        "dashboard/product/update_category/<int:category_id>/",
        views.edit_category,
        name="edit_category",
    ),
    path(
        "dashboard/product/delete_category/<int:category_id>/",
